                  ...
                  return (
                    <div key={c.id} className="sr"
                      ...
                      <div style={{ display:'flex',alignItems:'center',gap:8,position:'relative' }}
                        onMouseEnter={e=>{ if(c.latestNote){ const t=document.createElement('div'); t.id='sub-tooltip'; t.style.cssText='position:fixed;z-index:9999;background:#0f1521;border:1px solid rgba(255,255,255,.15);border-radius:8px;padding:8px 12px;font-size:12px;font-family:system-ui,sans-serif;color:#94a3b8;max-width:240px;pointer-events:none;box-shadow:0 4px 20px rgba(0,0,0,.6);white-space:pre-wrap;line-height:1.6;letter-spacing:.01em'; t.textContent=c.latestNote; document.body.appendChild(t); const r=e.currentTarget.getBoundingClientRect(); t.style.left=(r.left)+'px'; t.style.top=(r.bottom+4)+'px' }}}
